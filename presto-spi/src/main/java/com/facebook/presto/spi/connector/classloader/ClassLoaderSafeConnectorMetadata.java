        ...
        implements ConnectorMetadata
{
    ...
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.convertToTableScanPipeline(session, tableHandle, tablePipelineNode);
        }
    }
    ...
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.pushAggregationIntoScan(session, connectorTableHandle, currentPipeline, aggregation);
        }
    }

    @Override
    public Optional<TableScanPipeline> pushProjectIntoScan(ConnectorSession session, ConnectorTableHandle connectorTableHandle,
            TableScanPipeline currentPipeline, ProjectPipelineNode projects)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
    ...
    public Optional<TableScanPipeline> pushFilterIntoScan(ConnectorSession session, ConnectorTableHandle connectorTableHandle,
            TableScanPipeline currentPipeline, FilterPipelineNode filters)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
    ...
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.pushLimitIntoScan(session, connectorTableHandle, currentPipeline, limit);
        }
    }
    ...
    @Override
    public Optional<TableScanPipeline> pushRightJoinIntoScan(ConnectorSession connectorSession, ConnectorTableHandle connectorHandle, TableScanPipeline existingPipeline, JoinPipelineNode joinPipelineNode)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.pushRightJoinIntoScan(connectorSession, connectorHandle, existingPipeline, joinPipelineNode);
        }
    }
}
