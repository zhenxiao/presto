...
public class TestClientAuthenticationWithDT
{
            ...
            throws Exception
    {
        ...
        assertEquals("20190911_214710_00012_rk69b", first.getId());
        assertEquals("/v1/statement/20190911_214710_00012_rk69b/1", first.getNextUri().getPath());
        ...
        assertEquals("20190911_214710_00012_rk69b", second.getId());
        assertEquals("/v1/statement/20190911_214710_00012_rk69b/2", second.getNextUri().getPath());
        ...
        assertEquals("20190911_214710_00012_rk69b", third.getId());
