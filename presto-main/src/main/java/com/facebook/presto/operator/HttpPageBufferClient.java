        ...
        implements Closeable
{
    ...
    {
        this(httpClient, maxResponseSize, maxErrorDuration, acknowledgePages, location, clientCallback, scheduler, Ticker.systemTicker(), pageBufferClientCallbackExecutor, null, null);
    }
    ...
    public HttpPageBufferClient(
            ...
            Executor pageBufferClientCallbackExecutor)
    {
        this(httpClient, maxResponseSize, maxErrorDuration, acknowledgePages, location, clientCallback, scheduler, ticker, pageBufferClientCallbackExecutor, null, null);
    }
    ...
    {
        this(httpClient, maxResponseSize, maxErrorDuration, acknowledgePages, location, clientCallback, scheduler, Ticker.systemTicker(), pageBufferClientCallbackExecutor, taskManager, timeoutExecutor);
    }
            ...
            ScheduledExecutorService timeoutExecutor)
    {
        ...
        if (taskManager != null && strings.size() == 5 && "v1".equals(strings.get(0)) && "task".equals(strings.get(1)) && "results".equals(strings.get(3))) {
            this.taskId = new TaskId(strings.get(2));
    ...
    private synchronized ListenableFuture<PagesResponse> sendGetResultsRaw()
    {
    ...
    private synchronized ListenableFuture<PagesResponse> sendGetResultsHttp(URI uri)
    {
