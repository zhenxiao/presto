...
public interface Metadata
{
    ...
    Optional<TableScanPipeline> pushRightJoinIntoScan(Session session, TableHandle table, TableScanPipeline tableScanPipeline, JoinPipelineNode joinPipelineNode);
}
