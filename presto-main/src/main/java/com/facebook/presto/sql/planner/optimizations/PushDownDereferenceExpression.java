        ...
        implements PlanOptimizer
{
    ...
    public PlanNode optimize(PlanNode plan, Session session, Map<Symbol, Type> types, SymbolAllocator symbolAllocator, PlanNodeIdAllocator idAllocator)
    {
        ...
        return SimplePlanRewriter.rewriteWith(new Optimizer(session, metadata, sqlParser, symbolAllocator, idAllocator), plan, expressionInfoMap);
    }
            ...
            extends SimplePlanRewriter<Map<Expression, DereferenceInfo>>
    {
        ...
        private DereferenceInfo getDereferenceInfo(Expression expression)
        {
            ...
            Symbol base = BASE_EXTRACTOR.process(expression);
