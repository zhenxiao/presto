...
public class TestDelegationTokenAuthenticator
{
    ...
    private String buildValidDelegationToken(String owner) throws Exception
    {
        ...
        id.write(output);
        Token<DelegationTokenIdentifier> token = new Token<DelegationTokenIdentifier>(id.getBytes(), new byte[]{}, DelegationTokenIdentifier.HDFS_DELEGATION_KIND, new Text("presto"));
