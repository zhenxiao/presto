...
public final class AggregateGeoData
{
    ...
    @InputFunction
    public static void putJsonGeoVarchar(GeoData geoData, @SqlType(JSON) Slice id, @SqlType(VARCHAR) Slice geoShape)
    {
        geoData.addVarcharShape(id, geoShape);
    }
    ...
    @InputFunction
    public static void putJsonGeoVarbinary(GeoData geoData, @SqlType(JSON) Slice id, @SqlType(VARBINARY) Slice geoShape)
    {
        geoData.addBinaryShape(id, geoShape);
    }
    ...
    @InputFunction
    public static void putVarbinaryGeometry(GeoData geoData, @SqlType(VARBINARY) Slice geoShape)
    {
