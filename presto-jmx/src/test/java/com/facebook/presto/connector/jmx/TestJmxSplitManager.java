...
public class TestJmxSplitManager
{
            ...
            throws Exception
    {
        for (Node node : nodes) {
            ...
            ConnectorSplitSource splitSource = splitManager.getSplits(JmxTransactionHandle.INSTANCE, SESSION, layout, UNGROUPED_SCHEDULING, Optional.empty(), Optional.empty(), Optional.empty());
