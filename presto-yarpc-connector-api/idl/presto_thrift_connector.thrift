namespace java com.facebook.presto.connector.yarpc.api
...
struct PrestoThriftTableMetadata {
  1:  optional PrestoThriftSchemaTableName schemaTableName;
  2:  optional list<PrestoThriftColumnMetadata> columns;
  3: optional string comment;
...
struct PrestoThriftMarker {
  ...
  2:  optional PrestoThriftBound bound;
}
...
struct PrestoThriftSplit {
  1:  optional PrestoThriftId splitId;
  2:  optional list<PrestoThriftHostAddress> hosts;
}
...
struct PrestoThriftPageResult {
   ...
   */
  1:  optional list<PrestoThriftBlock> columnBlocks;
  2:  optional i32 rowCount;
...
struct PrestoThriftEquatableValueSet {
  1:  optional bool whiteList;
  2:  optional list<PrestoThriftBlock> values;
}

struct PrestoThriftRange {
  1:  optional PrestoThriftMarker low;
  2:  optional PrestoThriftMarker high;
}

struct PrestoThriftSplitBatch {
  1:  optional list<PrestoThriftSplit> splits;
...
struct PrestoThriftRangeValueSet {
  1:  optional list<PrestoThriftRange> ranges;
}
...
struct PrestoThriftDomain {
  1:  optional PrestoThriftValueSet valueSet;
  2:  optional bool nullAllowed;
}
