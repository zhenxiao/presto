...
public final class H3HexFunctions
{
    ...
    private static AreaUnit getAreaUnit(String unitStr) throws PrestoException
    {
    ...
    private static String unwrapAddress(@SqlType(StandardTypes.VARCHAR) Slice hexAddr) throws PrestoException
    {
    ...
    private static LengthUnit getLengthUnit(String unitStr) throws PrestoException
    {
                                         ...
                                         @SqlType(StandardTypes.VARCHAR) Slice hexAddr2)
    {
        ...
        try {
            return Long.valueOf(h3.h3Distance(hexAddrStr1, hexAddrStr2));
        }
        catch (DistanceUndefinedException e) {
            throw new PrestoException(NUMERIC_VALUE_OUT_OF_RANGE, "Distance cannot be computed for (" + hexAddrStr1 + ", " + hexAddrStr2 + ")");
        }
    }
    ...
    public static Block getGeometryFromH3Address(@SqlType(StandardTypes.VARCHAR) Slice hexAddr)
    {
        ...
        String hexAddrStr = unwrapAddress(hexAddr);
        GeoCoord centroid = h3.h3ToGeo(hexAddrStr);
    ...
    public static Long getH3Resolution(@SqlType(StandardTypes.VARCHAR) Slice hexAddr)
    {
        ...
        String hexAddrStr = unwrapAddress(hexAddr);
        return Long.valueOf(h3.h3GetResolution(hexAddrStr));
    }
                                    ...
                                    @SqlType(StandardTypes.BIGINT) long numRings)
    {
        ...
        try {
            ...
            throw new PrestoException(GENERIC_INTERNAL_ERROR, "Hex range contains a pentagon.");
        }
    }
                                    ...
                                    @SqlType(StandardTypes.BIGINT) long ringNumber)
    {
        ...
        try {
            ...
            throw new PrestoException(GENERIC_INTERNAL_ERROR, "Hex ring contains a pentagon.");
        }
    }
