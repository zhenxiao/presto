...
import com.facebook.presto.uber.client.UberStatementClient;
import com.facebook.presto.uber.jdbc.ColumnInfo.Nullable;
...
import static com.facebook.presto.uber.jdbc.ColumnInfo.setTypeInfo;
        ...
        implements ResultSet
{
    ...
    private final UberStatementClient client;
    ...
    PrestoResultSet(UberStatementClient client, long maxRows, Consumer<QueryStats> progressCallback)
            throws SQLException
    {
    ...
    private static List<Column> getColumns(UberStatementClient client, Consumer<QueryStats> progressCallback)
            throws SQLException
    {
            ...
            extends AbstractIterator<Iterable<List<Object>>>
    {
        ...
        private ResultsPageIterator(UberStatementClient client, Consumer<QueryStats> progressCallback)
        {
            this.client = requireNonNull(client, "client is null");
