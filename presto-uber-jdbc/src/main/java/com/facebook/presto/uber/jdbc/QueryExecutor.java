...
class QueryExecutor
{
    ...
    public UberStatementClient startQuery(ClientSession session, String query, Map<String, String> rpcProperties)
    {
        return new UberStatementClient(httpClient, session, query, rpcProperties);
    }
