...
import static com.facebook.presto.uber.jdbc.TestPrestoDriver.closeQuietly;
...
public class TestJdbcResultSet
{
    ...
    public void testObjectTypes()
            throws Exception
    {
        String sql = "SELECT 123, 12300000000, REAL '123.45', 1E-1, true, 'hello', 1.0E0 / 0.0E0, 0.0E0 / 0.0E0, ARRAY[1, 2], cast('foo' as char(5)), DECIMAL '0.1'";
