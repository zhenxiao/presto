...
public final class PinotQueryGenerator
{
     ...
     *
     * <p>Pinot Query would be constructed based on {$link #QUERY_TEMPLATE}, with additional info predicates (WHERE ...).
     *
     * @return the constructed Pinot Query
     */
    static String getPinotQuery(PinotConfig pinotConfig, List<PinotColumnHandle> columnHandles, String pinotFilter, String timeFilter, String tableName)
    {
        ...
        long limit = pinotConfig.getLimitAll();
